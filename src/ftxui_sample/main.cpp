...
// configuration step. It creates a namespace called `deepcraft`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", deepcraft::cmake::project_name, deepcraft::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", deepcraft::cmake::project_version);
      return EXIT_SUCCESS;
    }
